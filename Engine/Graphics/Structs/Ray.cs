...
namespace Engine.Graphics.Structs
{
    public struct Ray(Vector3 origin, Vector3 direction)
    {
        ...
        public bool Intersects(BoundingBox box) => Intersects(ref box);
        ...
        public static Ray Transform(Ray ray, Matrix4x4 mat) => new(Vector3.Transform(ray.Origin, mat), Vector3.Normalize(Vector3.TransformNormal(ray.Direction, mat)));
